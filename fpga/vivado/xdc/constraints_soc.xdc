...
# Target: HeteroSoC (design/HeteroSoC.v), dual-core (PIPELINED + OOOCore on
# one shared clock). No PACKAGE_PIN/IOSTANDARD constraints are added for any
# other port (rst_ooo, start_pipelined) -- there is no real board/package pin
# to assign in a boardless study.
