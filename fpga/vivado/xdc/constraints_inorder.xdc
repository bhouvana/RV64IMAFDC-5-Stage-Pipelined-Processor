...
# Target: PIPELINED (design/riscvpipeline.v). No PACKAGE_PIN/IOSTANDARD
# constraints are added for any other port (start, debug_*, uart_tx/uart_rx,
# mailbox_*) -- there is no real board/package pin to assign in a boardless
