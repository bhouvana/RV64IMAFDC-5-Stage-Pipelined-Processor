...
module tb_prf_unit;
    ...
    reg        rst = 0;
    reg  [5:0] raddr0 = 0, raddr1 = 0, raddr2 = 0, raddr3 = 0, raddr4 = 0, raddr5 = 0, raddr6 = 0, raddr7 = 0, raddr8 = 0, raddr9 = 0, raddr10 = 0;
    wire [63:0] rdata0, rdata1, rdata2, rdata3, rdata4, rdata5, rdata6, rdata7, rdata8, rdata9, rdata10;
    wire       rvalid0, rvalid1, rvalid2, rvalid3, rvalid4, rvalid5, rvalid6, rvalid7, rvalid8, rvalid9, rvalid10;
    ...
    PhysicalRegisterFile #(.XLEN(64), .NUM_PREGS(64), .NUM_AREGS(32)) dut(
        .clk(clk), .rst(rst),
        .raddr0(raddr0), .raddr1(raddr1), .raddr2(raddr2), .raddr3(raddr3), .raddr4(raddr4), .raddr5(raddr5), .raddr6(raddr6), .raddr7(raddr7), .raddr8(raddr8), .raddr9(raddr9), .raddr10(raddr10),
        .rdata0(rdata0), .rdata1(rdata1), .rdata2(rdata2), .rdata3(rdata3), .rdata4(rdata4), .rdata5(rdata5), .rdata6(rdata6), .rdata7(rdata7), .rdata8(rdata8), .rdata9(rdata9), .rdata10(rdata10),
        .rvalid0(rvalid0), .rvalid1(rvalid1), .rvalid2(rvalid2), .rvalid3(rvalid3), .rvalid4(rvalid4), .rvalid5(rvalid5), .rvalid6(rvalid6), .rvalid7(rvalid7), .rvalid8(rvalid8), .rvalid9(rvalid9), .rvalid10(rvalid10),
